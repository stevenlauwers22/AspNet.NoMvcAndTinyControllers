...
namespace AspNet.NoMvc.Mvc5
{
    public class NoMvcViewEngineExtensions : INoMvcViewEngineExtensions
    {
        ...
        public void RegisterNoMvcViewLocationFormats()
        {
            ...
            var areaMasterLocationFormats = _viewLocationFormatsProvider.GetAreaMasterLocationFormats().Distinct().ToList();
            ...
            var areaViewLocationFormats = _viewLocationFormatsProvider.GetAreaViewLocationFormats().Distinct().ToList();
