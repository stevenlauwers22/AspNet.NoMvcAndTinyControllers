...
namespace AspNet.TinyControllers.Mvc5.Sample
{
	public class MvcApplication : HttpApplication
    {
        ...
        private static void RegisterRoutes()
        {
            ...
            RouteTable.Routes.MapRoute(
                ...
                new[] { "AspNet.TinyControllers.Mvc5.Sample.Controllers" });
            RouteTable.Routes.MapRoute(
                "Root",
                "",
            ...
            // ControllerBuilder.Current.DefaultNamespaces.Add("AspNet.TinyControllers.Mvc5.Sample.Controllers");
        }
