...
{
    public class When_the_NoMvcControllerFactory_is_told_to_GetControllerType_with_fallback_on_Mvc_styled_controllers : NoMvcTest
    {
        [Fact]
        public void It_should_retrieve_the_controller_type_from_the_route_namespace()
        {
            ...
            var controllerType = mvcApplication.DefineControllerType(string.Format("{0}.Controllers", mvcApplicationName), "HomeController");
            mvcApplication.DefineControllerType(string.Format("{0}.Controllers", mvcApplicationName), "AccountsController");
            ...
            var controllerFactory = new NoMvcControllerFactory(new NoMvcControllerNameUnderscoreResolver());
        ...
        public void It_should_not_retrieve_the_controller_type()
        {
            ...
            var mvcApplicationName = Guid.NewGuid().ToString();
            var mvcApplication = MvcApplicationBuilder.Build(mvcApplicationName);
            mvcApplication.DefineControllerType(string.Format("{0}.Controllers", mvcApplicationName), "HomeController");
            mvcApplication.DefineControllerType(string.Format("{0}.Controllers", mvcApplicationName), "AccountsController");
